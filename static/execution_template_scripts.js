exeBtn="<table><tr><td><h3 style='margin-bottom:0px;margin-top:0px;'>Executions: </h3></td><td class='newExe' style='width:50px'><a class='btn btn-default btn-sm' href='#' role='button' id='newExe'>New</a></td>";
...
exeBtn+="<td style='width: 20px'></td><td class='deleteExe'><td></tr></table><hr style='margin-bottom:5px;margin-top:5px;'>"
