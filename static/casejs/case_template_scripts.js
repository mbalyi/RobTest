caseBtn="<div style='float:left;margin-top:5px;width:80%;'><h3 style='margin-bottom:0px;margin-top:0px;'>Cases: </h3></div><div style='float:right;margin-top:5px;width:20%;'><table><tr><td class='newCase' style='width:50px'><a class='btn btn-default btn-sm' href='#' role='button' id='newCase'>New</a></td>";
