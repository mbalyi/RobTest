setBtn="<div style='float:left;margin-top:5px;width:80%;'><h3 style='margin-bottom:0px;margin-top:0px;'>Sets: </h3></div><div style='float:right;margin-top:5px;width:20%;'><table><tr><td class='newSet' style='width:50px'><a class='btn btn-default btn-sm' href='#' role='button' id='newSet'>New</a></td>";
...
setBtn+="<td style='width: 20px'></td><td class='deleteCase'><td></tr></table><hr style='margin-bottom:5px;margin-top:5px;'></div>"
